...
(* dijkstra4: string -> string -> eki_t *)

let dijkstra4 shitenEkimei shutenEkimei = 
...
let test30 = dijkstra4 "tawaramachi" "ueno"
let test31 = dijkstra4 "ueno" "tawaramachi"
let test32 = dijkstra4 "shibuya" "gokokuji"
let test33 = dijkstra4 "myogadani" "meguro"
...
let rec print_eki_list l = match l with
  [] -> ()
  | first :: rest -> (print_eki first; print_eki_list rest)

let main shitenEkimei shutenEkimei = (print_string shitenEkimei; print_string shutenEkimei;
  let eki_list = dijkstra4 shitenEkimei shutenEkimei in (
    print_eki_list eki_list;
  )
)
